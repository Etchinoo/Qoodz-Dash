...
const OfferDetails = () => {
  ...
  return (
    <Layout header={headerOptions}>
      {pauseOffer && (
        <ModalContainer setOpen={setPauseOffer} show={false}>
          <PauseOfferForm id={id} setPauseOffer={setPauseOffer} />
        </ModalContainer>
      )}
      {offerData && (
        <Row style={{ alignItems: "flex-start" }} gap={"1rem"}>
          <Row>
            ...
            >
              <Row gap="1rem">
                ...
                />
                <Col>
                  <Title>{offerData.name}</Title>
                  <TypeText>Type : {offerData.offerType}</TypeText>
                </Col>
              </Row>
              <StatusCard>
                {/* <IndecatorBlock /> */}
                <Col>
                  <StateActive>State:{offerData.status}</StateActive>
                  <Row gap={"13px"}>
              ...
              <Col>
                ...
                <Row gap={"16px"}>
                  ...
                  <Row gap="1rem">
                    <DateText>{offerData.originalPrice} EGP</DateText>
                    <DateText>-</DateText>
                    <DateText>
                      {offerData.originalPrice -
                        (offerData.originalPrice * 15) / 100}{" "}
                      EGP
                    </DateText>
                  </Row>
                </Row>
          ...
          <Col gap={"1rem"} paddingVert={"24px"} style={{ maxWidth: "420px" }}>
            <PrimaryBtn onClick={() => nav("/offers/new")}>
              Start Offer
            </PrimaryBtn>
